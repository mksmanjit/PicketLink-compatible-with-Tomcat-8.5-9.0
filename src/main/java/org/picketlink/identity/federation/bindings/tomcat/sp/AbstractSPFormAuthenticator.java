...
public abstract class AbstractSPFormAuthenticator extends BaseFormAuthenticator {
     ...
     * (non-Javadoc)
     *
     * @see org.apache.catalina.authenticator.FormAuthenticator#doAuthenticate(org.apache.catalina.connector.Request,
    ...
    public boolean doAuthenticate(Request request, HttpServletResponse response) throws IOException {
        try {
            ...
            if (saveRestoreRequest && matchRequest(request)) {
                ...
                register(request, response, savedPrincipal, HttpServletRequest.FORM_AUTH, (String) session
